...
export const AMERICAN_VIRGIN_ISLANDS = 'VI';
...
export const BRITISH_VIRGIN_ISLANDS = 'VG';
...
export const COCOS_ISLANDS = 'CC';

export const COLOMBIA = 'CO';

export const COMOROS = 'KM';

export const CONGO_BRAZZAVILLE = 'CG';
...
export const DUTCH_ANTILLES = 'BQ';
...
export const KOSOVO = 'XK';

export const KUWAIT = 'KW';

export const KYRGYZSTAN = 'KG';

export const LAO_PEOPLE_DEMOCRATIC_REPUBLIC = 'LA';
...
export const NORTH_MACEDONIA = 'MK';
...
export const UNITED_STATES_OF_AMERICA = 'US';
